...
function FRView(){
    ...
    useEffect(()=>{
        const fetchData = async () => {
            try{
                const response = await fetch("http://localhost:8000/fr-table-view")
    ...
    try {
      const res = await fetch(`http://localhost:8000/fr-delete-row`, {
        method: "DELETE",
        headers: {
    ...
    const handleEditConfirm = async () => {
        ...
        try {
            const res = await fetch("http://localhost:8000/fr-update", {
                method: "PUT",
