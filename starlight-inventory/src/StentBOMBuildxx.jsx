...
function StentBOMBuildXX(){
  ...
  const allowedDescriptions = [
    "Catheter Extrusions DDPC32", "Starlight Stent System DDPC32", "Coated Pusher Tube DDPC32", "Distal LCT DDPC32"
  ]
...
useEffect(() => {
  ...
  fetch(`http://localhost:8000/kits?ids=${selectedKitId}`)
    .then((res) => res.json())
  ...
  setKitQuantities(prev => {
    ...
    return updatedKitQuantities;
      ...
      <button onClick={() => {
                              ...
                              const quantity = Object.values(kitQuantities)[0];
...
export default StentBOMBuildXX;